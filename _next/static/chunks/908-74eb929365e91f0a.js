  ...
  [908],
  {
                ...
                (a.prototype.write = function (t, e, r, n) {
                  ...
                  for (var m = !1; ; )
                    switch (n) {
                      ...
                      case 'utf-8':
                        return (
                          (u = e), (f = r), C(R(t, this.length - u), this, u, f)
                        );
                      case 'ascii':
    ...
    7908: function (t, e, r) {
      ...
      let C =
        ...
        k = '0123456789',
        F = { DIGIT: k, ALPHA: _, ALPHA_DIGIT: _ + _.toUpperCase() + k },
        I = c('AsyncFunction');
      var D = {
        isArray: p,
        isArrayBuffer: y,
        ...
        function f(t, r, o) {
          ...
          if (t && !o && 'object' == typeof t) {
            if (D.endsWith(r, '{}'))
              ...
              var f;
              if (
                (D.isArray(t) && ((f = t), D.isArray(f) && !f.some(J))) ||
                ((D.isFileList(t) || D.endsWith(r, '[]')) && (a = D.toArray(t)))
              )
                return (
                  (r = W(r)),
                ...
                D.forEach(r, function (r, i) {
                  !0 ===
                    (!(D.isUndefined(r) || null === r) &&
                      o.call(e, r, D.isString(i) ? i.trim() : i, n, c)) &&
                    t(r, n ? n.concat(i) : [i]);
                }),
                l.pop();
            }
      ...
      let ti = 'undefined' != typeof window && 'undefined' != typeof document,
        ts =
          ...
          ti && 0 > ['ReactNative', 'NativeScript', 'NS'].indexOf(i)),
        ta =
      ...
      var tu = {
          ...s,
          isBrowser: !0,
          classes: { URLSearchParams: tr, FormData: tn, Blob: to },
        ...
        transformRequest: [
          function (t, e) {
            ...
            let n = e.getContentType() || '',
              ...
              i = D.isObject(t);
            if (
              (i && D.isHTMLForm(t) && (t = new FormData(t)), D.isFormData(t))
            )
              return o ? JSON.stringify(tf(t)) : t;
            if (
              D.isArrayBuffer(t) ||
              D.isBuffer(t) ||
              D.isStream(t) ||
      ...
      class tb {
        ...
        static accessor(t) {
          let e = (this[tp] = this[tp] = { accessors: {} }).accessors,
            r = this.prototype;
          function n(t) {
            let n = td(t);
            e[n] ||
      ...
      function tv(t, e, r) {
        M.call(this, null == t ? 'canceled' : t, M.ERR_CANCELED, e, r),
      ...
      tb.accessor([
        ...
        D.reduceDescriptors(tb.prototype, ({ value: t }, e) => {
            ...
            return new Promise(function (e, r) {
              ...
              if (
                (l.open(
                  ...
                  Q(c, t.params, t.paramsSerializer),
                  !0,
                ),
                (l.timeout = t.timeout),
                'onloadend' in l
                ...
                (l.onabort = function () {
                  l &&
                    (r(new M('Request aborted', M.ECONNABORTED, t, l)),
                    (l = null));
                }),
                (l.onerror = function () {
                ...
                tu.hasStandardBrowserEnv &&
                  (u && D.isFunction(u) && (u = u(t)),
                  u || (!1 !== u && tS(c))))
              ) {
                let e =
                  t.xsrfHeaderName &&
                  t.xsrfCookieName &&
                  tA.read(t.xsrfCookieName);
                e && s.set(t.xsrfHeaderName, e);
              }
              void 0 === i && s.setContentType(null),
                'setRequestHeader' in l &&
                  D.forEach(s.toJSON(), function (t, e) {
                ...
                'function' == typeof t.onDownloadProgress &&
                  l.addEventListener('progress', tT(t.onDownloadProgress, !0)),
                'function' == typeof t.onUploadProgress &&
                  l.upload &&
                  l.upload.addEventListener('progress', tT(t.onUploadProgress)),
                (t.cancelToken || t.signal) &&
                  ((n = (e) => {
                    l &&
                      (r(!e || e.type ? new tv(null, t, l) : e),
                      l.abort(),
                      (l = null));
                  }),
      ...
      let tC = (t) => `- ${t}`,
        tU = (t) => D.isFunction(t) || null === t || !1 === t;
      var tx = {
        getAdapter: (t) => {
          let e, r;
          let { length: n } = (t = D.isArray(t) ? t : [t]),
            o = {};
          for (let i = 0; i < n; i++) {
            let n;
            if (
              ((r = e = t[i]),
              !tU(e) && void 0 === (r = tB[(n = String(e)).toLowerCase()]))
            )
      ...
      function tj(t) {
        return (
          ...
          (t.data = tw.call(t, t.transformRequest)),
          -1 !== ['post', 'put', 'patch'].indexOf(t.method) &&
            t.headers.setContentType('application/x-www-form-urlencoded', !1),
          tx
            .getAdapter(t.adapter || tl.adapter)(t)
            .then(
              function (e) {
                return (
                  tN(t),
                  (e.data = tw.call(t, t.transformResponse, e)),
      ...
      class tM {
        ...
        getUri(t) {
          return Q(
            tO((t = tL(this.defaults, t)).baseURL, t.url),
            t.params,
            t.paramsSerializer,
          );
        }
      ...
      D.forEach(['delete', 'get', 'head', 'options'], function (t) {
        tM.prototype[t] = function (e, r) {
          return this.request(
            tL(r || {}, { method: t, url: e, data: (r || {}).data }),
          );
        };
      }),
      ...
      let tH = (function t(e) {
        ...
        return (
          D.extend(n, tM.prototype, r, { allOwnKeys: !0 }),
      ...
      (tH.Axios = tM),
        ...
        (tH.mergeConfig = tL),
        (tH.AxiosHeaders = tb),
        (tH.formToJSON = (t) => tf(D.isHTMLForm(t) ? new FormData(t) : t)),
        (tH.getAdapter = tx.getAdapter),
        (tH.HttpStatusCode = tz),
        (tH.default = tH);
      var tJ = tH;
    },
  },
